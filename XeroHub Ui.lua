...
function Library:CreateWindow(info)
                ...
                tw(
                    {
                        ...
                        d = "Out",
                        g = {CanvasSize = UDim2.new(0, 0, 0, UIListLayout.AbsoluteContentSize.Y + Plus or 5)}
                    }
                ):Play()
            end
        )
        ...
        local function UpdateOrientation(fetchProps)
            ...
            do
                ...
                if rot ~= 0 and rot % 180 ~= 0 then
                    ...
                    local vec = tl
                    tl =
                        Vector2.new(c * (tl.x - mid.x) - s * (tl.y - mid.y), s * (tl.x - mid.x) + c * (tl.y - mid.y)) +
                        mid
                    tr =
                        Vector2.new(c * (tr.x - mid.x) - s * (tr.y - mid.y), s * (tr.x - mid.x) + c * (tr.y - mid.y)) +
                        mid
                    bl =
                        Vector2.new(c * (bl.x - mid.x) - s * (bl.y - mid.y), s * (bl.x - mid.x) + c * (bl.y - mid.y)) +
                        mid
                    br =
                        Vector2.new(c * (br.x - mid.x) - s * (br.y - mid.y), s * (br.x - mid.x) + c * (br.y - mid.y)) +
                        mid
                end
            end
            DrawQuad(
    ...
    BackgroundTransparency = 0.5
        ...
        ClickButtonCircle.Position =
            UDim2.new(
            0,
            p2.AbsolutePosition.X - p.AbsolutePosition.X + p2.AbsoluteSize.X / 2,
            0,
            p2.AbsolutePosition.Y - p.AbsolutePosition.Y + p2.AbsoluteSize.Y / 2
        )
        ClickButtonCircle.Size = UDim2.new(0, 0, 0, 0)
        ClickButtonCircle.ZIndex = 10
            ...
            tw(
                {
                    ...
                    s = Enum.EasingStyle.Linear,
                    d = "InOut",
                    g = {Position = UDim2.new(d.X.Scale, d.X.Offset + dt.X, d.Y.Scale, d.Y.Offset + dt.Y)}
                }
            ):Play()
        end
    ...
    BackgroundTransparency = 0.5
        ...
        local function twSelect()
            ...
            local targetX =
                (Tab.AbsolutePosition.X - tabScrollingFrame.AbsolutePosition.X) +
    ...
    BackgroundTransparency = 0.5
            ...
            local function twSelect()
                ...
                local targetY =
                    (Tab_2.AbsolutePosition.Y - tabScrollingFrame.AbsolutePosition.Y) +
                    ...
                    tw(
                        {
                            ...
                            s = Enum.EasingStyle.Linear,
                            d = "Out",
                            g = {Size = UDim2.new(0, TextBox_1.TextBounds.X + 10, 0, 15)}
                        }
                    ):Play()
                    ...
                    tw(
                        {
                            ...
                            s = Enum.EasingStyle.Exponential,
                            d = "Out",
                            g = {Size = UDim2.new(0, 300, 0, 300), Position = UDim2.new(0.5, 0, 0.5, 0)}
                        }
                    ):Play()
                    tw({v = UIStroke_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {Transparency = 0}}):Play(
    ...
    BackgroundTransparency = 0.5
                    ...
                    ClickItem.MouseButton1Click:Connect(
                        function()
                            if Multi then
                    ...
                    tw(
                        {
                            ...
                            s = Enum.EasingStyle.Linear,
                            d = "Out",
                            g = {Size = UDim2.new(0, textSize.X + 20, 0, 25)}
                        }
                    ):Play()
                end
    ...
    BackgroundTransparency = 0.5
                ...
                tw(
                    {
                        ...
                        s = Enum.EasingStyle.Linear,
                        d = "Out",
                        g = {Size = UDim2.new(0, UIPageLayout_1.CurrentPage.TextBounds.X + 50, 0, 25)}
                    }
                ):Play()

                Right_1.MouseButton1Click:Connect(
                    function()
                        UIPageLayout_1:Next()
                ...
                Left_1.MouseButton1Click:Connect(
                    function()
    ...
    BackgroundTransparency = 0.5
                ...
                TextLabel_2.MouseButton1Click:Connect(
                    function()
                        jc(Click, Discord)
                        pcall(Callback)
                        tw(
                        ...
                        tw(
                            {
                                ...
                                s = Enum.EasingStyle.Exponential,
                                d = "Out",
                                g = {Size = UDim2.new(sizeRatio, 0, 0, 4)}
                            }
                        ):Play()
                        task.wait(1)
                    end
