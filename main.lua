...
-- ✅ เปิดการใช้งานช่องค้นหา
am.SearchBarEnabled = true
an.SearchBarHeight = 28
...
function aq.Search(keyword)
    keyword = string.lower(keyword or "")
    for _, tab in pairs(am.Tabs) do
        if string.find(string.lower(tab.Name), keyword, 1, true) then
